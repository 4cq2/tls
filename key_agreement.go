...
func (ka rsaKeyAgreement) generateServerKeyExchange(config *_Config, cert *_Certificate, clientHello *clientHelloMsg, hello *serverHelloMsg) (*serverKeyExchangeMsg, error) {
	return nil, nil
}

func (ka rsaKeyAgreement) processClientKeyExchange(config *_Config, cert *_Certificate, ckx *clientKeyExchangeMsg, version uint16) ([]byte, error) {
...
func (ka rsaKeyAgreement) processServerKeyExchange(config *_Config, clientHello *clientHelloMsg, serverHello *serverHelloMsg, cert *x509.Certificate, skx *serverKeyExchangeMsg) error {
	return errors.New("tls: unexpected ServerKeyExchange")
}

func (ka rsaKeyAgreement) generateClientKeyExchange(config *_Config, clientHello *clientHelloMsg, cert *x509.Certificate) ([]byte, *clientKeyExchangeMsg, error) {
...
func (ka *ecdheKeyAgreement) processClientKeyExchange(config *_Config, cert *_Certificate, ckx *clientKeyExchangeMsg, version uint16) ([]byte, error) {
...
func (ka *ecdheKeyAgreement) processServerKeyExchange(config *_Config, clientHello *clientHelloMsg, serverHello *serverHelloMsg, cert *x509.Certificate, skx *serverKeyExchangeMsg) error {
	if len(skx.key) < 4 {
...
func (ka *ecdheKeyAgreement) generateClientKeyExchange(config *_Config, clientHello *clientHelloMsg, cert *x509.Certificate) ([]byte, *clientKeyExchangeMsg, error) {
	if ka.ckx == nil {
