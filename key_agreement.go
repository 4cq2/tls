...
func (ka rsaKeyAgreement) generateServerKeyExchange(config *Config, cert *_Certificate, clientHello *clientHelloMsg, hello *serverHelloMsg) (*serverKeyExchangeMsg, error) {
	return nil, nil
}

func (ka rsaKeyAgreement) processClientKeyExchange(config *Config, cert *_Certificate, ckx *clientKeyExchangeMsg, version uint16) ([]byte, error) {
...
func (ka *ecdheKeyAgreement) generateServerKeyExchange(config *Config, cert *_Certificate, clientHello *clientHelloMsg, hello *serverHelloMsg) (*serverKeyExchangeMsg, error) {
...
func (ka *ecdheKeyAgreement) processClientKeyExchange(config *Config, cert *_Certificate, ckx *clientKeyExchangeMsg, version uint16) ([]byte, error) {
